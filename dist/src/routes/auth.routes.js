...
router.post('/upload-photo', auth_controller_1.authController.uploadPhoto);
router.post('/verify-otp', auth_controller_1.authController.verifyOtp);
// POST /api/auth/resend-otp
router.post('/resend-otp', rateLimit_middleware_1.rateLimitMiddleware.otp, auth_controller_1.authController.resendOtp);
// POST /api/auth/login
// Body: { email, password }
